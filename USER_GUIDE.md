...
“资产库”统一保存歌曲、作品、人声、伴奏、参考音色、歌词、曲风、ABC 乐谱和模型。导入音频前先选择类型，上传完成即可试听和查看波形；“发送到…”可把素材直接放入歌曲创作、乐谱计划、参考音色或 RVC 训练，不必重复上传。文本素材可编辑并建立新版本。加入项目时固定当前素材版本，之后修改文本或替换素材不会悄悄改变旧项目。`userdata/assets` 保存按 SHA-256 去重的文件，`userdata/library.sqlite3` 保存项目、版本和来源关系，更新器会保留两者。
