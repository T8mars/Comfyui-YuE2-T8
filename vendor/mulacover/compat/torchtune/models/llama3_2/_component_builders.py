...
# The bundled compatibility slice is inference-only.  Quantized base and LoRA
# builders remain unavailable while the ordinary llama3_2 builder stays intact.
FrozenNF4Linear = None
DoRALinear = LoRALinear = None
LORA_ATTN_MODULES = str
